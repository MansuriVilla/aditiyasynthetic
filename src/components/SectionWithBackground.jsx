...
export const SectionWithBackground = () => {
    return (
        <section className="section_with_background">
            <div className="section_with_background-inner site_flex site_flex-column">
                <div className="section_with_background-image hero_background site_flex">
                    <img src="/assets/our-philosophy.webp" alt="Hero Section Image" className="section_with_background-image" />   
                </div>
                <div className="section_with_background-overlay">
                    <div className="section_with_background-overlay-inner site_flex site_flex-column">
                        ...
                        <div className="section_with_background-center">
                            ...
                            <p className="section_with_background-description">Aditya Synthetic is a family owned business manufacturing reactive dyes.
What started off as a small unit in Ahmedabad, has today spread its wings
across many countries over multiple continents. Armed with a state-of-the-art manufacturing unit, an advanced RnD department, two high tech labs and
...
of the customer, we have been the first choice of all sizes of clients.</p>
                        </div>
